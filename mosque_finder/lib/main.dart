...
import 'package:mosque_finder/test.dart';
...
class MyApp extends StatelessWidget {
  ...
  Future<void> _checkPermissionsAndInitialize() async {
    bool hasPermission = await PermissionHandler.checkLocationPermission(context);
    if (hasPermission) {
      ...
      await PermissionHandler.showPermissionDialog(
        ...
        onPermissionDenied: () {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text('Using default location. Some features may be limited.'),
            ...
            children: [
              ...
              Row(
                children: [
                  Expanded(
                    child: Container(
                      ...
                      child: DropdownButton<String>(
                        ...
                        icon: const Icon(Icons.arrow_drop_down, color: Color(0xFF16C47F)),
                        items: [
                        ...
                        onChanged: (String? value) {
                          if (value != null) {
                            ref.read(mosqueFinderProvider.notifier).updateSearchRadius(value);
                          }
                        },
                      ),
                    ),
                  ...
                  SizedBox(width: 12.w),
                  ElevatedButton.icon(
                    onPressed: () => ref.read(mosqueFinderProvider.notifier).getCurrentLocation(),
      ...
      child: Column(
        ...
        children: [
          FloatingActionButton(
            heroTag: 'refresh',
            onPressed: () => ref.read(mosqueFinderProvider.notifier).searchNearbyMosques(),
            backgroundColor: const Color(0xFF16C47F),
          ...
          FloatingActionButton(
            ...
            child: const Icon(Icons.center_focus_strong, color: Color(0xFF16C47F)),
          ),
        ],
      ),
    );
